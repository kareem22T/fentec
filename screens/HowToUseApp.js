...
export default function HowToUseApp({ navigation }) {
...

                {
                    slideNo != 4 && (
                        <View style={styles.navigation}>
                            ...
                            <TouchableOpacity style={styles.navigate_btn} onPress={slideNo > 1 ? () => setSlideNo(slideNo - 1) : () => navigation.navigate('Profile')}>
                                <Image source={require('./../assets/imgs/icons/angle-left.png')} style={styles.navigate_img} />
                            </TouchableOpacity>
                            <TouchableOpacity style={styles.navigate_btn} onPress={slideNo < 4 ? () => setSlideNo(slideNo + 1) : () => setIsFirstTime().then(() => { navigation.navigate('Profile') })}>
                ...
                }
                {
                    slideNo == 4 && (
                        <View style={[styles.navigation, {position: "absolute", bottom: 0}]}>
                            <TouchableOpacity style={[styles.navigate_btn, {borderWidth: 2, borderColor: "#fff"}]} onPress={slideNo > 1 ? () => setSlideNo(slideNo - 1) : () => navigation.navigate('Profile')}>
                                <Image source={require('./../assets/imgs/icons/angle-left.png')} style={styles.navigate_img} />
                            </TouchableOpacity>
                            <TouchableOpacity style={[styles.navigate_btn, {borderWidth: 2, borderColor: "#fff"}]} onPress={slideNo < 4 ? () => setSlideNo(slideNo + 1) : () => setIsFirstTime().then(() => { navigation.navigate('Profile') })}>
                                <Image source={require('./../assets/imgs/icons/angle-right.png')} style={styles.navigate_img} />
                            </TouchableOpacity>
                        </View>
                    )
